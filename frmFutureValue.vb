Public Class frmFutureValue
    ...
    Private Sub ClearAllBoxes(sender As Object, e As EventArgs) Handles Me.DoubleClick, txtFutureValue.MouseHover
    ...
    Private Sub txtYears_DoubleClick(sender As Object, e As EventArgs) Handles txtYears.DoubleClick

        txtYears.Text = CStr(10)
